...
\begin{document}
	...
	\part{Beschreibung der Entities}
		...
		\section{game\_mechanic\_ent}
			%TODO blockdiagramm
			%TODO multiplexen der rows für die player
		...
		\section{graphics\_ent}
			...
			%TODO wie ist das gemeint? player_id und spielfeldkodierung vermischt? -> kodierung für spielfeld ins game_state kapitel, spielerkodierung in eigene tabelle hier
			%TODO schwarzer rand lel
			\begin{table}[H]
				\centering
				\label{tileCode}
				\begin{tabular}{|l|l|}
	...
	\part{Probleme}
		...
		\section{game\_mechanic\_ent}
			...
			\subsection{player\_ent}
				...
				\subsubsection{movement\_ent}
					Lange Zeit hatten wir ein Problem damit, dass die Spielfiguren in Blöcke hineinglitchen konnten, falls sie sich auf zwei Kacheln gleichzeitig befanden und in Richtung des Blockes bewegten. Der Fehler ergab sich wie folgt: 
